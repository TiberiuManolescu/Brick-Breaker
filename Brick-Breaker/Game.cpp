...
void Game::setupButtons() {
    ...
    levelButton.setSize({ 150.f, 50.f });
    levelButton.setPosition((window.getSize().x - 150) / 2.0f, window.getSize().y / 2.0f);
    levelButton.setFillColor(sf::Color::Yellow);
    levelText = createText(levelButton, "Level", font, 45);
...
void Game::draw() {
    ...
    finalScoreText.setPosition(10, window.getSize().y - finalScoreText.getLocalBounds().height - 10); // Adjust position to bottom left
    ...
    finalTimeText.setPosition(window.getSize().x - finalTimeText.getLocalBounds().width - 10,
                              window.getSize().y - finalTimeText.getLocalBounds().height - 10); // Position in the bottom right corner
